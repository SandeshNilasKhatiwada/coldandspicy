...
function TheYourOrder() {
  ...
  return (
    <div className="flex flex-col justify-center h-[88vh] px-[10%]">
      <div className="h-[85vh] custom-scroll border bg-black shadow-lg p-2">
        <div className="sticky top-0 bg-black">
          <h2 className="text-xl text-center primary-color mt-2 font-bold mb-4">
            Your Orders
          </h2>
        </div>{" "}
        <div className="overflow-x-auto h-[75vh] custom-scroll">
          <table className="table-auto min-w-full">
            <thead className="sticky top-0 bg-black border-b">
